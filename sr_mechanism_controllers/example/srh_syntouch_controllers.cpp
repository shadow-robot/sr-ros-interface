...
namespace controller {
  ...
  bool SrhSyntouchController::init(ros_ethercat_mechanism_model::RobotState *robot, const std::string &joint_name)
  {
    ROS_DEBUG(" --------- ");
  ...
  bool SrhSyntouchController::init(ros_ethercat_mechanism_model::RobotState *robot, ros::NodeHandle &n)
  {
    assert(robot);
    node_ = n;
