...
namespace controller {
  ...
  bool SrhExampleController::init(ros_ethercat_model::Robot *robot, ros::NodeHandle &n)
  {
    assert(robot);
    node_ = n;
  ...
  bool SrhExampleController::init(ros_ethercat_model::Robot *robot, const std::string &joint_name)
  {
    assert(robot);
    robot_ = robot;
