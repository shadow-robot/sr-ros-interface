...
namespace controller {
  ...
  bool SrhEffortJointController::init(ros_ethercat_mechanism_model::Robot *robot, const std::string &joint_name)
  {
    ROS_DEBUG(" --------- ");
  ...
  bool SrhEffortJointController::init(ros_ethercat_mechanism_model::Robot *robot, ros::NodeHandle &n)
  {
    assert(robot);
    node_ = n;
