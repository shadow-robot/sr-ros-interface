...
namespace controller {
  ...
  bool SrhJointMuscleValveController::init(ros_ethercat_model::Robot *robot, const std::string &joint_name)
  {
    ROS_DEBUG(" --------- ");
  ...
  bool SrhJointMuscleValveController::init(ros_ethercat_model::Robot *robot, ros::NodeHandle &n)
  {
    assert(robot);
    node_ = n;
