...
namespace controller {
  ...
  bool SrhJointPositionController::init(ros_ethercat_model::Robot *robot, const std::string &joint_name,
  ...
  bool SrhJointPositionController::init(ros_ethercat_model::Robot *robot, ros::NodeHandle &n)
  {
    assert(robot);
    node_ = n;
