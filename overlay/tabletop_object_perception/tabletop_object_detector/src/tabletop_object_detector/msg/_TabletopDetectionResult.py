"""autogenerated by genmsg_py from TabletopDetectionResult.msg. Do not edit."""
...
class TabletopDetectionResult(roslib.message.Message):
  _md5sum = "87f0570d8cfb4df6a26b195ab114ed3b"
  _type = "tabletop_object_detector/TabletopDetectionResult"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Containts all the information from one run of the tabletop detection node
...
"""
  ...
  _slot_types = ['tabletop_object_detector/Table','sensor_msgs/PointCloud[]','household_objects_database_msgs/DatabaseModelPose[]','int32[]','int32']
