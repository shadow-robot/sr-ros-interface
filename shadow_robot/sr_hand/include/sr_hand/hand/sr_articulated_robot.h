...
namespace debug_values
{
  ...
  static const std::map<const std::string, const std::vector<double> > joints_to_test
    = boost::assign::map_list_of ( "FFJ0", const_cast<std::vector<double> >(joint_targets)) \
                                 ( "FFJ3", const_cast<std::vector<double> >(joint_targets)) \
                                 ( "FFJ4", const_cast<std::vector<double> >(joint_targets));
}
