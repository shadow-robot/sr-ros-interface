...
import sys
sys.path.append("..")
from fitness_function.partial_fitnesses.partial_fitness_MSE import Partial_Fitness_MSE
from fitness_function.partial_fitnesses.partial_fitness_oscillations import Partial_Fitness_Oscillations
from fitness_function.partial_fitnesses.partial_fitness_overshoot import Partial_Fitness_Overshoot
from fitness_function.partial_fitnesses.partial_fitness_risetime import Partial_Fitness_RiseTime
from fitness_function.partial_fitnesses.partial_fitness_settlingtime import Partial_Fitness_SettlingTime
from utils.get_data.get_nbr_targets import Get_Nbr_Targets
