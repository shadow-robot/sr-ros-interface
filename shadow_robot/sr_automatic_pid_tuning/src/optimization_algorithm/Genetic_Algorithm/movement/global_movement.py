...
from partial_movement_sinus import Partial_Movement_Sinus
from partial_movement_big_steps import Partial_Movement_Big_Steps
from partial_movement_small_steps import Partial_Movement_Small_Steps
from partial_movement_slope import Partial_Movement_Slope
import pickle
import os
import signal
...
class Global_Movement(object):
    def __init__(self,joint_name,instance_callback):
    ...
    def run_movement_on_robot(self):
        ...
        movement=[Partial_Movement_Sinus(self.joint_name),Partial_Movement_Big_Steps(self.joint_name),Partial_Movement_Small_Steps(self.joint_name),Partial_Movement_Slope(self.joint_name)]
