...
class Genetic_Algorithm(object):
    ...
    def __init__(self,populationSize, numberOfGenerations,
                 parameters_set, global_movement,
	...
	"""
	self.matrix=genome
	robot_tree_config=Robot_Tree_Config_Automatic(self.matrix,self.joint_name, self.instance_callback, self.robot_lib, self.global_movement)
