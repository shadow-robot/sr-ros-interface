...
*
 * @brief  This compatibility interface is a wrapper around the new CAN Hand
 ...
 * you should probably use the CAN ROS interface directly.
 *
 *
 */

#ifndef   	_CAN_COMPATIBILITY_ARM_HPP_
# define   	_CAN_COMPATIBILITY_ARM_HPP_
 ...
 *
 */
  class CANCompatibilityArm : public SRArticulatedRobot
  {
  public:
    /**
