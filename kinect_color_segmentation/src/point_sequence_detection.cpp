...
namespace sr_kinect
{
  ...
  bool PointSequenceDetection::srv_callback(kinect_color_segmentation::GetSegmentedLine::Request& request, kinect_color_segmentation::GetSegmentedLine::Response& response)
  {
